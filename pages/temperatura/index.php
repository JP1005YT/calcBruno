...
<body>
    ...
    <nav class="menu">
        <ul>
            ...
            <li><a href="../conversor/">Conversão</a></li>
        </ul>
    </nav>
    ...
    <div class="div-conteudo">
        <form method="POST" action="../../logica/processamento.php">
            ...
            <input type="text" name="tempvalue" placeholder="Digite os graus" required>
            <select name="selectOperacoes">
                <option value="CelciusParaFarenheit">Celcius Para Farenheit</option>
                <option value="FarenheitParaCelcius">Farenheit Para Celcius</option>
            </select>
